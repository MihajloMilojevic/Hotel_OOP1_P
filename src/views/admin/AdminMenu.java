...
public class AdminMenu extends JMenuBar {
	...
	public AdminMenu(JFrame parent) {
				...
				dialog.addWindowListener(new WindowAdapter() {
					...
					public void windowClosed(WindowEvent windowEvent) {
						...
						case SUCCESS:
							...
							JOptionPane.showMessageDialog(parent.getContentPane(), "Profile updated successfully", "Success",
		...
		item.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				int res = JOptionPane.showConfirmDialog(parent.getContentPane(), "Are you sure you want to logout?", "Logout",
