			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						if (name.isBlank()) {
							JOptionPane.showMessageDialog(AddGuestDialog.this, "Name is required", "Error", JOptionPane.ERROR_MESSAGE);
							return;
						}
						if (surname.isBlank()) {
							JOptionPane.showMessageDialog(AddGuestDialog.this, "Surname is required", "Error",
									JOptionPane.ERROR_MESSAGE);
							return;
						}
						if (username.isBlank()) {
							JOptionPane.showMessageDialog(AddGuestDialog.this, "Username is required", "Error",
									JOptionPane.ERROR_MESSAGE);
							return;
						}
						if (password.isBlank()) {
							JOptionPane.showMessageDialog(AddGuestDialog.this, "Password is required", "Error",
									JOptionPane.ERROR_MESSAGE);
							return;
						}
						
						if (birthdateDP.getDate() == null) {
							JOptionPane.showMessageDialog(AddGuestDialog.this, "Date of birth is required", "Error",
									JOptionPane.ERROR_MESSAGE);
							return;
						}
						if (address.isBlank()) {
							JOptionPane.showMessageDialog(AddGuestDialog.this, "Address is required", "Error",
									JOptionPane.ERROR_MESSAGE);
							return;
						}
						if (phone.isBlank()) {
							JOptionPane.showMessageDialog(AddGuestDialog.this, "Phone is required", "Error",
									JOptionPane.ERROR_MESSAGE);
							return;
						}
